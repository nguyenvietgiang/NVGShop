...
public class DatabaseHelper extends SQLiteOpenHelper {
   ...
   public boolean checkLogin(String userName, String password) {
    ...
    public void addProduct(String name, String description, double price , String type) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public void updateProduct(int productId, String name, String description, double price , String type) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_PRODUCT_NAME, name);
        values.put(COLUMN_PRODUCT_DESCRIPTION, description);
    ...
    public List<Product> getAllProducts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                String type = cursor.getString(cursor.getColumnIndex(COLUMN_PRODUCT_TYPE));
